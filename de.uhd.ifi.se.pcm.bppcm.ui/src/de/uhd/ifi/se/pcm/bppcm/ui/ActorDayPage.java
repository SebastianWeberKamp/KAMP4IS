...
/**
 * ActorDayPage implements the Page of the Wizard ActorDayWizard.
 * The actor is able to choose a day profile for the selected 
 * day. The current day is shown in the head. 
 * 
 *  @param calendar 	the ActorCalendar where this wizard was opened
 ...
 *
 */
public class ActorDayPage extends WizardPage { 
	   ...
	   * 
	   * @param actorCalendar		the actorCalendar view which opened the wizard 
	  ...
	  public ActorDayPage(ActorCalendar actorCalendar, String i, String m) {
	    ...
	    setDescription("Current day profile: " + calendar.days.get(index).
	    		getProfile().getName());
	  }
	   ...
	   * can be changed.  
	   * 
	   * @param parent		parent Composite of this wizard page
	   * 
	   * (non-Javadoc)
	    ...
	    list.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (list.getSelectionCount() > 0) {
					...
					calendar.days.get(index).setProfile(calendar.getDayprofiles().
							get(i));
