...
/**
 * NovemberContentProvider is a ContentProvider, that is need
 * to visualize the month November in the calendar.
 * 
 * @author Annika
 *
 */
public class NovemberContentProvider extends AdapterFactoryContentProvider {

	public NovemberContentProvider() {
