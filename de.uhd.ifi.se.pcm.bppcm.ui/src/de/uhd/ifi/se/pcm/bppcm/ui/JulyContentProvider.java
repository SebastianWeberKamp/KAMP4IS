...
/**
 * JulyContentProvider is a ContentProvider, that is need
 * to visualize the month July in the calendar.
 * 
 * @author Annika
 *
 */
public class JulyContentProvider extends AdapterFactoryContentProvider {

	public JulyContentProvider() {
