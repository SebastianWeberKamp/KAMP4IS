...
/**
 * FebruaryContentProvider is a ContentProvider, that is need
 * to visualize the month February in the calendar.
 * 
 * @author Annika
 *
 */
public class FebruaryContentProvider extends AdapterFactoryContentProvider {

	public FebruaryContentProvider() {
