...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IS Modify Role</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4is.model.modificationmarks.impl.ISModifyRoleImpl#getSignatureModifications <em>Signature Modifications</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ISModifyRoleImpl<T extends Role> extends ISModifyEntityImpl<T> implements ISModifyRole<T> {
	/**
	...
	protected EClass eStaticClass() {
		return ISModificationmarksPackage.Literals.IS_MODIFY_ROLE;
	}
	...
	public EList<ISModifySignature> getSignatureModifications() {
		if (signatureModifications == null) {
			signatureModifications = new EObjectContainmentEList<ISModifySignature>(ISModifySignature.class, this, ISModificationmarksPackage.IS_MODIFY_ROLE__SIGNATURE_MODIFICATIONS);
		}
