...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4req.model.modificationmarks.ReqModifyTraceableObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReqModifyTraceableObjectItemProvider extends AbstractModificationItemProvider {
	...
	public String getText(Object object) {
		String label = ((ReqModifyTraceableObject<?>)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ReqModifyTraceableObject_type") :
			getString("_UI_ReqModifyTraceableObject_type") + " " + label;
	}
