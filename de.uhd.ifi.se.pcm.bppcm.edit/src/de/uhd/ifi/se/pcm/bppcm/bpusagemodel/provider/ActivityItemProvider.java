...
public class ActivityItemProvider extends AbstractUserActionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BpusagemodelPackage.Literals.ACTIVITY__SCENARIO);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Activity.class)) {
			case BpusagemodelPackage.ACTIVITY__SCENARIO:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BpusagemodelPackage.Literals.ACTIVITY__SCENARIO,
