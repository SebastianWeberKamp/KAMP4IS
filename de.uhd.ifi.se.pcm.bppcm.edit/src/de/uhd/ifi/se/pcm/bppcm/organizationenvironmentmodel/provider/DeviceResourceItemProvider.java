...
/**
 * This is the item provider adapter for a {@link de.uhd.ifi.se.pcm.bppcm.organizationenvironmentmodel.DeviceResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceResourceItemProvider extends EntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceResource_capacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceResource_capacity_feature", "_UI_DeviceResource_type"),
				 OrganizationenvironmentmodelPackage.Literals.DEVICE_RESOURCE__CAPACITY,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrganizationenvironmentmodelPackage.Literals.DEVICE_RESOURCE__CAPACITY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeviceResource.class)) {
