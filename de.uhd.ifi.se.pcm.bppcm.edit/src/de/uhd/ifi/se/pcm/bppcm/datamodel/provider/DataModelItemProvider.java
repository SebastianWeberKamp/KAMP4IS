...
/**
 * This is the item provider adapter for a {@link de.uhd.ifi.se.pcm.bppcm.datamodel.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatamodelPackage.Literals.DATA_MODEL__DATA_OBJECTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataModel.class)) {
			case DatamodelPackage.DATA_MODEL__DATA_OBJECTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatamodelPackage.Literals.DATA_MODEL__DATA_OBJECTS,
				 DatamodelFactory.eINSTANCE.createCollectionDataObject()));

		newChildDescriptors.add
			(createChildParameter
				(DatamodelPackage.Literals.DATA_MODEL__DATA_OBJECTS,
				 DatamodelFactory.eINSTANCE.createCompositeDataObject()));
	}
