...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IS Unit Test Case</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4is.model.fieldofactivityannotations.impl.ISUnitTestCaseImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4is.model.fieldofactivityannotations.impl.ISUnitTestCaseImpl#getProvidedrole <em>Providedrole</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ISUnitTestCaseImpl extends ISTestCaseImpl implements ISUnitTestCase {
	...
	public NotificationChain basicSetParent(ISTestSpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(ISTestSpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ISFieldOfActivityAnnotationsPackage.IS_TEST_SPECIFICATION__UNIT_TEST_CASES, ISTestSpecification.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT, newParent, newParent));
	}
		...
		if (providedrole != null && ((EObject)providedrole).eIsProxy()) {
			...
			if (providedrole != oldProvidedrole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PROVIDEDROLE, oldProvidedrole, providedrole));
			}
		}
		return providedrole;
	}
	...
	public void setProvidedrole(OperationProvidedRole newProvidedrole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PROVIDEDROLE, oldProvidedrole, providedrole));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT:
				return eInternalContainer().eInverseRemove(this, ISFieldOfActivityAnnotationsPackage.IS_TEST_SPECIFICATION__UNIT_TEST_CASES, ISTestSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PARENT:
				return getParent();
			case ISFieldOfActivityAnnotationsPackage.IS_UNIT_TEST_CASE__PROVIDEDROLE:
