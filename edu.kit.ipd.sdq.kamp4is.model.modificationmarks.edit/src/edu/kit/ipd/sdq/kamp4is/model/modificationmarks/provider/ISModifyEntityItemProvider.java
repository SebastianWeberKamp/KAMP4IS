...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4is.model.modificationmarks.ISModifyEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ISModifyEntityItemProvider extends edu.kit.ipd.sdq.kamp.model.modificationmarks.provider.AbstractModificationItemProvider {
	 ...
	 * @generated
	 */
	public ISModifyEntityItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		...
		String label = ISLabelCustomizing.customize((ISModifyEntity<?>) object);
		// --End manually modified code
		return label == null || label.length() == 0 ?
			getString("_UI_ISModifyEntity_type") :
			getString("_UI_ISModifyEntity_type") + " " + label;
	}
