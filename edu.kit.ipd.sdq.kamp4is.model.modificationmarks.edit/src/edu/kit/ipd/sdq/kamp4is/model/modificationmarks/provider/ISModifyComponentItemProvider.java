...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4is.model.modificationmarks.ISModifyComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ISModifyComponentItemProvider
	...
	/**
	 * This returns ISModifyComponent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ISModifyComponent"));
	}
	...
	public String getText(Object object) {
		...
		String label = ISLabelCustomizing.customize((ISModifyComponent) object);
		// --End manually modified code
		return label == null || label.length() == 0 ?
			getString("_UI_ISModifyComponent_type") :
			getString("_UI_ISModifyComponent_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ISModificationmarksPackage.Literals.IS_MODIFY_COMPONENT__PROVIDED_ROLE_MODIFICATIONS,
				 ISModificationmarksFactory.eINSTANCE.createISModifyProvidedRole()));
